...
c = requests.session()
bot_username = '@Million_Abot'
tepthon = ['yes']


@sbb_b.on(admin_cmd(pattern="(تجميع المليون|تجميع مليون)"))
async def _(event):
    if tepthon[0] == "yes":
        ...
        await sbb_b.send_message('@Million_Abot', '/start')
        await asyncio.sleep(5)
        msg0 = await sbb_b.get_messages('@Million_Abot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await sbb_b.get_messages('@Million_Abot', limit=1)
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفة') != -1:
            ...
            try:
                ...
                msg2 = await sbb_b.get_messages('@Million_Abot', limit=1)
